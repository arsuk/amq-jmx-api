...
public enum DataTypeArtemis {
    ...
    public static DataTypeArtemis fromAlias(String alias) {
        ...
        throw new IllegalArgumentException(String.format("Invalid DataType alias '%s'; supported are %s ", alias, Arrays.deepToString(Stream.of(DataTypeArtemis.values()).map(DataTypeArtemis::alias).toArray())));
    }
