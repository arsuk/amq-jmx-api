...
public enum DataType {
    ...
    public static DataType fromAlias(String alias) {
        ...
        throw new IllegalArgumentException(String.format("Invalid DataType alias '%s'; supported are %s ", alias, Arrays.deepToString(Stream.of(DataType.values()).map(x -> x.alias()).toArray())));
    }
