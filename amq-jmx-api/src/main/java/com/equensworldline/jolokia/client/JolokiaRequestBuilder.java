...
public class JolokiaRequestBuilder {
    ...
    public String buildQueryRequest() {
        ...
        case STORAGE:
            ...
            break;
        case TEST:
            //input = "{\"type\":\"read\",\"mbean\":\"org.apache.activemq:type=Broker,brokerName=*,connector=clientConnectors,connectorName=openwire+ssl,connectionViewType=clientId,connectionName=*\"}";
